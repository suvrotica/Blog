<script lang="ts">
	...
	figCaption = 'SuvroGhosh.BLOG',
	txtHeading = `About this blog`,
	txtContent = `Although flippant, this blog is a scratchpad of thoughts, a much-sought-after extension of my
	...
	pragmatist, join me in the infinite mosaic of collective nonsense we can explore.`}=$props();
</script>
